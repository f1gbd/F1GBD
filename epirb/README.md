...
[![Decoder](https://img.shields.io/badge/decoder-v5.21-blue)](https://github.com/f1gbd/F1GBD/releases/download/epirb-v5.21/EPIRBdecoder.7z)
[![Generator](https://img.shields.io/badge/generator-v3.8.2-blue)](https://github.com/f1gbd/F1GBD/releases?q=epirb)
...
### 🆕 v5.21 / v3.8.2 — Conformité protocole COSPAS-SARSAT renforcée
...
### 📥 [**Télécharger EPIRB Suite v5.21 (Windows)**](https://github.com/f1gbd/F1GBD/releases/download/epirb-v5.21/EPIRBdecoder.7z) · [**SATERfinder Android v1.0 (APK)**](https://github.com/f1gbd/F1GBD/tree/master/epirb/saterfinder)
...
|---|---|---|
| 📡 **EPIRB Decoder** (v5.21) | Windows 10/11 | Décodeur complet 406 MHz — RTL-SDR, Audio Live, WAV, Hex direct, codes protocole officiels + **National Location**, position 4 s, carte OSM/triangulation, **APRS-IS**, SITREP PDF |
| 🛰 **EPIRB Generator** (v3.8.2) | Windows 10/11 | Générateur de trames d'exercice 406 MHz — émission audio directe, PTT série, signal Manchester 400 bauds conforme COSPAS-SARSAT T.001 |
...
|---|---|---|
| **1. Source logicielle** | EPIRB Generator v3.8.2 | Trame test : 227 (France), protocole 14 (Std Loc. RLS), ID 0425A4 |
...
| **6. Décodeur** | EPIRB Decoder v5.21 | Mode **Audio Live** (entrée USB Audio Codec) — décodage immédiat |
...
#### 📥 [**Télécharger EPIRBdecoder.7z (Suite complète)**](https://github.com/f1gbd/F1GBD/releases/download/epirb-v5.21/EPIRBdecoder.7z)

*(archive contenant Decoder v5.21 + Generator v3.8.2 — voir [toutes les releases EPIRB](https://github.com/f1gbd/F1GBD/releases?q=epirb) pour les versions précédentes)*
...
|---|---|
| **v5.21** | **Version courante** — Conformité protocole renforcée : décodage **National Location** (code 15) avec sa structure de position propre et **offset fin 4 s** (signalé par le bit 110), **table des codes officiels** C-S, polynôme **BCH-1 corrigé**, mode CLI `--file --json` (décodage sans GUI). |
...
| Version | Apport principal |
|---|---|
| **v3.8.2** | **Version courante** — Position **National Location à 4 s** (offset PDF-2), mise en cohérence complète avec le décodeur (codes officiels, BCH-1, familles Standard / National), test aller-retour fonctionnant en **source et en exe** |
...
│                                                                      │
│  ┌────────────────────────────┐  ┌────────────────────────────────┐  │
│  │  EPIRB Generator v3.7      │  │  EPIRB Decoder v5.21           │  │
...
**EPIRB Decoder v5.21 + EPIRB Generator v3.8.2 — Juin 2026**
