...
[![Version](https://img.shields.io/badge/version-epirb--v5.1.0-blue)](https://github.com/f1gbd/F1GBD/releases/tag/epirb-v5.1.0)
...
### 📥 [**Télécharger la dernière version stable (v5.1.0)**](https://github.com/f1gbd/F1GBD/releases/download/epirb-v5.1.0/EPIRBdecoder.7z)
...
#### 📥 [**Télécharger EPIRBdecoder.7z (v5.1.0)**](https://github.com/f1gbd/F1GBD/releases/download/epirb-v5.1.0/EPIRBdecoder.7z)

*(version `epirb-v5.1.0` — voir [toutes les releases EPIRB Decoder](https://github.com/f1gbd/F1GBD/releases?q=epirb) pour les versions précédentes)*
...
|---|---|
| **v5.1.0** | **Version courante** — Carte plein écran, collage rapide Google Maps, force du signal dans les relevés, panneau relevés optimisé |
