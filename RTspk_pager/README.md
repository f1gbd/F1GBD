...
1. Télécharger l'APK (lien direct) : **[RTspk_pager-1.0.52.apk](https://github.com/f1gbd/F1GBD/releases/download/1.0.52/RTspk_pager-1.0.52.apk)**.
...
**1.0.52 — Couche météo AROME, règle des 3×30 et zones à surveiller.** Un bouton
