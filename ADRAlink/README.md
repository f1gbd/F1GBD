...
Dernière version : **v1.0.0** (https://github.com/f1gbd/F1GBD/releases/download/adralink-v1.0.0/ADRAlink.7z).

- 💻 **Windows** — archive `ADRAlink.7z` (contient
  `ADRAlink_serveur.exe` + `ADRAlink_client.exe`) :
  [**ADRAlink.7z**](https://github.com/f1gbd/F1GBD/releases/download/adralink-v1.0.0/ADRAlink.7z)
- 📱 **Android (APK)** :
  [**ADRAlink_client.apk**](https://github.com/f1gbd/F1GBD/releases/download/adralink-v1.0.0/ADRAlink_client.apk)
...
*ADRAlink v1.0.0 — © 2026 F1GBD / ADRASEC 77. Licence GNU GPL v3.0.*
