...
> comme le web-flasher (RASEC-ALERT + MAIL ADRAlink + CHAPPE26). Et la passerelle
> **cesse d'interroger un identifiant supprimé** (réponse **404** après une RAZ /
> purge du store) : fin du flot de requêtes inutiles.
>
